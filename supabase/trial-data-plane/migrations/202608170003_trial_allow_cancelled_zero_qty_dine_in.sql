-- Trial data-plane mirror of the Primary dine-in cancellation trigger contract.
-- Only the existing positive-to-zero cancelled UPDATE transition is permitted;
-- inserts, negative quantities, and ordinary zero quantity updates remain invalid.
