-- Trial data-plane mirror of the Primary dine-in KDS terminal cleanup.
-- Preserve POS/KDS decoupling while preventing closed table bills from reappearing on KDS.
