-- Close the race where a Kitchen ticket arrives after a dine-in bill is already terminal.
-- Non-dine-in modes remain decoupled because takeaway/delivery may be paid before cooking finishes.
