...
export default async function MdmPage() {
  ...
  const { data: devices, error } = await supabase
    .from("branch_devices")
    .select("id,tenant_id,branch_id,device_code,device_name,status,last_seen_at,app_version")
