...
/**
 * Fast native raster path for diagnostic/test text that has no rich HTML template.
 *
 * Customer-facing receipt, payment-notice and kitchen-ticket documents use the established HTML
 * renderer in 1.0.20. This lightweight renderer remains only for diagnostic/test output.
 *
 * The tail advance is deliberately compact: six standard ESC/POS line feeds are about 25 mm,
 * enough to clear a typical tear bar without wasting the ~10 cm of paper used by early 1.0.19.
 */
internal class NativeTextRasterizer {
    ...
    companion object {
        ...
        internal const val TAIL_FEED_LINES = 6
        internal const val APPROX_TAIL_FEED_MM = 25
    }
}
