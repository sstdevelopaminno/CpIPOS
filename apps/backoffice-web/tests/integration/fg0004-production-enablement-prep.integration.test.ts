...
describe("FG0004 production Restaurant QR enablement prep", () => {
  ...
  it("prepares FG0004 inactive transaction without QR traffic, users, MDM, or printer hardware", () => {
    ...
    expect(fg0004ProvisioningSql).toContain("FG0004_TENANT_ALREADY_EXISTS");
    expect(fg0004ProvisioningSql).toContain("FG0004_BRANCH_ALREADY_EXISTS");
    expect(fg0004ProvisioningSql).toContain("FG0004_POS_DEVICE_ALREADY_EXISTS");
